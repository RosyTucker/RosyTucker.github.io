...
![Activity Lifecycle]({{site.url}}/images/posts/AndroidWorkshops/LifeCycle.png){:class="article-image"}
...
If you run this now it should look something like this: [Showing Items]({{site
.url}}/images/posts/AndroidWorkshops/ShowingItems.png){:class="article-image"}
...
![Dialog]({{site.url}}/images/posts/AndroidWorkshops/Dialog.png){:class="article-image"}
...
![Done]({{site.url}}/images/posts/AndroidWorkshops/Done.png){:class="article-image"}
